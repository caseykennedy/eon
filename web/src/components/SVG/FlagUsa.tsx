...
const FlagUsa = () => (
  <svg viewBox="0 0 36.6 31.2">
    <title>USA Flag</title>
    <path
      fill="#ea001f"
      d="M21.3,2.6L21.3,2.6L21,2.9h13.3c-0.1-0.1-0.2-0.2-0.2-0.3C30.5-0.9,24.8-0.9,21.3,2.6z"
    />
    <path fill="#ea001f" d="M18.3,10h18.3c0.1-1.2,0-2.4-0.3-3.6h-18V10z" />
    <path
      fill="#ea001f"
      d="M18.2,17.2L18.2,17.2l14.1,0l1.7-1.7c0.6-0.6,1.1-1.2,1.5-1.9H18.3L18.2,17.2L18.2,17.2z"
    />
    <polygon fill="#ea001f" points="7.9,20.8 11.5,24.4 25.1,24.4 28.7,20.8 	" />
    <polygon fill="#ea001f" points="21.2,28.3 15.4,28.3 18.3,31.2 	" />
    <path
      fill={theme.colors.primary}
      d="M18.3,5.5l-2.8-2.8c0,0,0,0-0.1-0.1L15,2.9l0.4,1.5l-1.3-0.8l-1.2,0.8l0.4-1.5l-1.1-1h1.4l0.2-0.6
    ...
    />
    <path fill={theme.colors.primary} d="M5,1C4.5,1.2,3.9,1.6,3.5,2h1.2L5,1z" />
    <path
      fill={theme.colors.white}
      d="M1.6,3.9C1.6,4,1.5,4.1,1.4,4.2l0.3,0.2L1.6,3.9z"
    />
    <path
      fill={theme.colors.white}
      d="M4,4.4l1.2-0.8l1.3,0.8L6.1,2.9l1.1-1H5.8L5.3,0.8C5.2,0.9,5.1,0.9,5,1L4.7,2H3.5C3.4,2,3.4,2,3.4,2l1,0.9
		L4,4.4z"
    />
    <polygon
      fill={theme.colors.white}
      points="8.5,4.4 9.7,3.6 11,4.4 10.6,2.9 11.7,2 10.3,2 9.7,0.5 9.2,2 7.8,2 8.9,2.9 	"
    />
    <path
      fill={theme.colors.white}
      d="M12.2,2l1.1,1l-0.4,1.5l1.2-0.8l1.3,0.8L15,2.9l0.4-0.3c-0.5-0.5-1-0.9-1.6-1.2L13.6,2H12.2z"
    />
    <path
      fill={theme.colors.white}
      d="M2.4,12.6H1l-0.6-1.5l-0.1,0.4c0.2,0.9,0.6,1.7,1.2,2.5l-0.1-0.5L2.4,12.6z"
    />
    <polygon
      fill={theme.colors.white}
    ...
    <polygon
      fill={theme.colors.white}
      points="14.7,12.6 14.1,11.2 13.6,12.6 12.2,12.6 13.3,13.6 12.9,15.1 14.1,14.3 15.4,15.1 15,13.6 16.1,12.6 
			"
    />
    <path
      fill={theme.colors.white}
    ...
    <polygon
      fill={theme.colors.white}
      points="5.3,9.8 6.5,8.9 7.8,9.8 7.4,8.3 8.5,7.3 7.1,7.3 6.5,5.8 6,7.3 4.6,7.3 5.7,8.3 	"
    />
    <polygon
      fill={theme.colors.white}
      points="11,5.8 10.5,7.3 9.1,7.3 10.2,8.3 9.8,9.8 11,8.9 12.3,9.8 11.9,8.3 13,7.3 11.6,7.3 	"
    />
    <polygon
      fill={theme.colors.white}
